<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddEmployee.aspx.cs" Inherits="BookSaleFairProject.AddEmployee" MasterPageFile="~/Site.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <dx:ASPxPanel ID="ASPxPanel1" runat="server" CssClass="centered main-panel">
        <PanelCollection>
            <dx:PanelContent>
                <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Add New Employee" Font-Size="X-Large"></dx:ASPxLabel>
                <br />
                <br />
                ...
                <br />
                <dx:ASPxButton ID="btnSignUp" runat="server" Text="Add Employee" Style="margin-right: 20px;" OnClick="btnSignUp_Click"></dx:ASPxButton>
